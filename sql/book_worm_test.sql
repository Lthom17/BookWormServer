drop database if exists book_worm_test;
create database book_worm_test;
use book_worm_test;
...
('bc06c542-7179-402f-8c61-b8aa1741a672', 'Gorillaz', 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Mus mauris vitae ultricies leo integer.', 'FriesNFrosties', 'e6e21270-b280-4edb-9739-a1d192689fa6');
